...
For easier installation and cleaner environment, we recommend using  [conda](https://docs.conda.io/en/latest/miniconda.html) (a popular environment management tool) with Python 3.9 here.
